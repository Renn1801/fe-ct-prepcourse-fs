...
function crearGato(nombre, edad) {
   ...
   // Retornar el objeto.
   // Tu código:
   var crearGato = {nombre: nombre, edad: edad, meow: function () {
      return ("Meow!")
      }
   }
   return (crearGato)
...
function sumarLikesDeUsuario(objetoUsuario) {
   ...
   for (var i = 0; i < objetoUsuario.posts.length; i++) {
      ...
      likesDeLosPosts.push(result) 
   }
   var suma = likesDeLosPosts.reduce(function (a, b) {
   return a + b }, 0)
   return (suma)
}
...
function agregarMetodoCalculoDescuento(objetoProducto) {
   ...
   var precioConDescuento = this.precio * this.porcentajeDeDescuento;
   return this.precio - precioConDescuento;
   };
